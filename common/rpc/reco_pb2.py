...
_USERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='UserRequest.timestamp', index=3,
...
_TRACK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='like', full_name='Track.like', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='repost', full_name='Track.repost', index=3,
...
_USERARTICLERECOMMEND = _descriptor.ServiceDescriptor(
  name='UserArticleRecommend',
  full_name='UserArticleRecommend',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='user_recommend',
    full_name='UserArticleRecommend.user_recommend',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_USERARTICLERECOMMEND)

DESCRIPTOR.services_by_name['UserArticleRecommend'] = _USERARTICLERECOMMEND
